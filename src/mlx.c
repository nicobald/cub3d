...
/*   Updated: 2026/03/19 22:11:34 by utilisateur      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_line(t_data_game *game, int x, int y)
{
	while (game->player->x_pixel_position < SCREEN_WIDTH && game->player->x_pixel_position >= 0 
		...
		{
			mlx_pixel_put(game->win->mlx_ptr, game->win->win_ptr, game->player->x_pixel_position, game->player->y_pixel_position, CUSTOM);
